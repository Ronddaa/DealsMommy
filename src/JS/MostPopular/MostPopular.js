...
const cardList = document.getElementById("mostPopularCardsList");
...
products.forEach((product) => {
  ...
  slide.innerHTML = `
    <div class="swiper-slide shadow-sm border-0 mostPopularCard" style="width: 18rem;">
  <img src="${product.image}" alt="Product Image" class="mostPopularCard-img-top cardsIMGsize">
  <div class="mostPopular-body">
    <h5 class="mostPopularCard-title">${product.title}</h5>
    <p class="text-muted"><s>Was: ${product.priceBefore}</s></p>
    <p class="fs-4 fw-bold textPrice">${product.priceNow}</p>
    <button class="btnMoreDGreen">
